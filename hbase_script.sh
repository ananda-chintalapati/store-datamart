...
CREATE TABLE store_aggr (key int, store_id int, total_sale_units double, total_sale_amount double) STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler'
...
CREATE TABLE vendor_aggr (key int, vendor_id int, vendor_nm string, total_sale_units double, total_sale_amount double) STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler'
...
CREATE TABLE month_aggr (key int, month int, total_sale_units double, total_sale_amount double) STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler'
...
CREATE TABLE dept_aggr (key int, dept_id int, dept_nm string, total_sale_units double, total_sale_amount double) STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler'
